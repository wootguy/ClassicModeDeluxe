...
namespace ClassicModeDeluxe {
	...
	{
		modelReplacements["models/otis.mdl"] = "models/cm_v1/otis.mdl";
		modelReplacements["models/otisf.mdl"] = "models/cm_v1/otisf.mdl";
		modelReplacements["models/zombie_barney.mdl"] = "models/cm_v1/zombie_barney.mdl";
		modelReplacements["models/zombie_soldier.mdl"] = "models/cm_v1/zombie_soldier.mdl";
		modelReplacements["models/hgrunt_medic.mdl"] = "models/cm_v1/hgrunt_medic.mdl";
		modelReplacements["models/hgrunt_medicf.mdl"] = "models/cm_v1/hgrunt_medicf.mdl";
		modelReplacements["models/hgrunt_opfor.mdl"] = "models/cm_v1/hgrunt_opfor.mdl";
		modelReplacements["models/hgrunt_opforf.mdl"] = "models/cm_v1/hgrunt_opforf.mdl";
		modelReplacements["models/hgrunt_torch.mdl"] = "models/cm_v1/hgrunt_torch.mdl";
		modelReplacements["models/hgrunt_torchf.mdl"] = "models/cm_v1/hgrunt_torchf.mdl";
		modelReplacements["models/massn.mdl"] = "models/cm_v1/massn.mdl";
		modelReplacements["models/massnf.mdl"] = "models/cm_v1/massnf.mdl";
		modelReplacements["models/rgrunt.mdl"] = "models/cm_v1/rgrunt.mdl";
		modelReplacements["models/rgruntf.mdl"] = "models/cm_v1/rgruntf.mdl";
		modelReplacements["models/hwgrunt.mdl"] = "models/cm_v1/hwgrunt.mdl";
		modelReplacements["models/hwgruntf.mdl"] = "models/cm_v1/hwgruntf.mdl";
		modelReplacements["models/osprey.mdl"] = "models/cm_v1/osprey.mdl";
		modelReplacements["models/osprey2.mdl"] = "models/cm_v1/osprey2.mdl";
		modelReplacements["models/ospreyf.mdl"] = "models/cm_v1/ospreyf.mdl";
		modelReplacements["models/blkop_apache.mdl"] = "models/cm_v1/blkop_apache.mdl";
		modelReplacements["models/blkop_osprey.mdl"] = "models/cm_v1/blkop_osprey.mdl";
		modelReplacements["models/apachef.mdl"] = "models/cm_v1/apachef.mdl";
		modelReplacements["models/agruntf.mdl"] = "models/cm_v1/agruntf.mdl";
		modelReplacements["models/strooper.mdl"] = "models/cm_v1/strooper.mdl";
		modelReplacements["models/bgman.mdl"] = "models/cm_v1/bgman.mdl";
		modelReplacements["models/w_shock_rifle.mdl"] = "models/cm_v1/w_shock_rifle.mdl";
		modelReplacements["models/barnabus.mdl"] = "models/cm_v1/barnabus.mdl";
		modelReplacements["models/hassassinf.mdl"] = "models/cm_v1/hassassinf.mdl";
		modelReplacements["models/hgruntf.mdl"] = "models/cm_v1/hgruntf.mdl";
		modelReplacements["models/islavef.mdl"] = "models/cm_v1/islavef.mdl";
		modelReplacements["models/player.mdl"] = "models/cm_v1/player.mdl";
		modelReplacements["models/gonome.mdl"] = "models/cm_v1/gonome.mdl";
		modelReplacements["models/tor.mdl"] = "models/cm_v1/tor.mdl";
		modelReplacements["models/torf.mdl"] = "models/cm_v1/Torf.mdl";
		modelReplacements["models/hgrunt.mdl"] = "models/cm_v1/hgrunt.mdl";
		modelReplacements["models/hlclassic/barney.mdl"] = "models/hlclassic/barney.mdl";
		modelReplacements["models/hlclassic/hgrunt.mdl"] = "models/cm_v1/hgrunt.mdl"; // the vanilla classic grunt is missing rpg anims
		...
		modelReplacements["models/v_saw.mdl"] = "models/cm_v1/v_saw.mdl";
		modelReplacements["models/p_saw.mdl"] = "models/cm_v1/p_saw.mdl";
		modelReplacements["models/w_saw.mdl"] = "models/cm_v1/w_saw.mdl";
		modelReplacements["models/v_m40a1.mdl"] = "models/cm_v1/v_m40a1.mdl";
		modelReplacements["models/p_m40a1.mdl"] = "models/cm_v1/p_m40a1.mdl";
		modelReplacements["models/w_m40a1.mdl"] = "models/cm_v1/w_m40a1.mdl";
		modelReplacements["models/v_spore_launcher.mdl"] = "models/cm_v1/v_spore_launcher.mdl";
		modelReplacements["models/p_spore_launcher.mdl"] = "models/cm_v1/p_spore_launcher.mdl";
		modelReplacements["models/w_spore_launcher.mdl"] = "models/cm_v1/w_spore_launcher.mdl";
		modelReplacements["models/v_displacer.mdl"] = "models/cm_v1/v_displacer.mdl";
		modelReplacements["models/p_displacer.mdl"] = "models/cm_v1/p_displacer.mdl";
		modelReplacements["models/w_displacer.mdl"] = "models/cm_v1/w_displacer.mdl";
		modelReplacements["models/w_pipe_wrench.mdl"] = "models/cm_v1/w_pipe_wrench.mdl";
		modelReplacements["models/v_pipe_wrench.mdl"] = "models/cm_v1/v_pipe_wrench.mdl";
		modelReplacements["models/p_pipe_wrench.mdl"] = "models/cm_v1/p_pipe_wrench.mdl";
		// TODO: dual and golden uzi models don't work (except for view model)
		modelReplacements["models/v_uzi.mdl"] = "models/cm_v1/v_uzi.mdl";
		modelReplacements["models/p_uzi.mdl"] = "models/cm_v1/p_uzi.mdl";
		modelReplacements["models/w_uzi.mdl"] = "models/cm_v1/w_uzi.mdl";
		//modelReplacements["models/w_2uzis.mdl"] = "models/cm_v1/w_2uzis.mdl";
		modelReplacements["models/p_2uzis.mdl"] = "models/cm_v1/p_2uzis.mdl";
		modelReplacements["models/p_uzi_gold.mdl"] = "models/cm_v1/p_uzi_gold.mdl";
		modelReplacements["models/w_uzi_gold.mdl"] = "models/cm_v1/w_uzi_gold.mdl";
		modelReplacements["models/p_2uzis_gold.mdl"] = "models/cm_v1/p_2uzis_gold.mdl";
		//modelReplacements["models/w_2uzis_gold.mdl"] = "models/cm_v1/w_2uzis_gold.mdl";
		modelReplacements["models/v_minigun.mdl"] = "models/cm_v1/v_minigun.mdl";
		modelReplacements["models/p_minigunidle.mdl"] = "models/cm_v1/p_minigunidle.mdl";
		modelReplacements["models/p_minigunspin.mdl"] = "models/cm_v1/p_minigunspin.mdl";
		modelReplacements["models/w_minigun.mdl"] = "models/cm_v1/w_minigun.mdl";
		modelReplacements["models/v_desert_eagle.mdl"] = "models/cm_v1/v_desert_eagle.mdl";
		modelReplacements["models/w_desert_eagle.mdl"] = "models/cm_v1/w_desert_eagle.mdl";
		modelReplacements["models/p_desert_eagle.mdl"] = "models/cm_v1/p_desert_eagle.mdl";
		modelReplacements["models/v_bgrap.mdl"] = "models/cm_v1/v_bgrap.mdl";
		modelReplacements["models/p_bgrap.mdl"] = "models/cm_v1/p_bgrap.mdl";
		modelReplacements["models/w_bgrap.mdl"] = "models/cm_v1/w_bgrap.mdl";
		modelReplacements["models/v_shock.mdl"] = "models/cm_v1/v_shock.mdl";
		modelReplacements["models/p_shock.mdl"] = "models/cm_v1/p_shock.mdl";
		modelReplacements["models/w_uzi_clip.mdl"] = "models/cm_v1/w_uzi_clip.mdl";
		modelReplacements["models/w_saw_clip.mdl"] = "models/cm_v1/w_saw_clip.mdl";
		modelReplacements["models/w_m40a1clip.mdl"] = "models/cm_v1/w_m40a1clip.mdl";
		...
		soundReplacements["monster_barney"] = "../cm_v1/barney.txt";
		soundReplacements["monster_bodyguard"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_grunt_ally_repel"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_grunt_repel"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_human_assassin"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_human_grunt"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_human_grunt_ally"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_hwgrunt"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_hwgrunt_repel"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_male_assassin"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_robogrunt"] = "../cm_v1/weapons.txt";
		soundReplacements["monster_robogrunt_repel"] = "../cm_v1/weapons.txt";
		...
		if (mapType != MAP_HALF_LIFE)
		{
			...
			if (mapType == MAP_BLUE_SHIFT)
			{
				...
				g_Game.PrecacheModel("models/cm_v1/bshift/v_satchel_radio.mdl");
			}
			if (mapType == MAP_OPPOSING_FORCE)
			{
				subfolder = "op4/";
				force_replace = op4_force_replace;
				g_Game.PrecacheModel("models/cm_v1/op4/v_satchel_radio.mdl");
			}
